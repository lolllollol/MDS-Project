...
# If need to remove footer, then use above with %>% head(n) where n is the last line of the text
...
# If the book also has parts we can similarly get a part number for each line
